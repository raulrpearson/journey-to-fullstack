...
- Another great guide to [great commit
  messages](https://github.com/RomuloOliveira/commit-messages-guide). Also,
  check ["My favorite
  commit"](https://fatbusinessman.com/2019/my-favourite-git-commit) for some
  more tips on crafting great commit messages.
